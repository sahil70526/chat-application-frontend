...
function Home() {
  ...
  return (
    <>
      ...
      <div 
      // className="bg-[#282C35!] scrollbar-hide z-10 h-[100vh]  lg:w-[90%] lg:mx-auto overflow-y-hidden shadow-2xl"
      >
        ...
        <div className='flex'>
          ...
          <Chat className="chat-page relative lg:w-[100%] h-[100vh] bg-[#ece5dd]" />
